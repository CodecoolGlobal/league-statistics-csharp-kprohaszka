...
namespace Codecool.LeagueStatistics.View
{
    ...
    public static class Display
    {
        ...
        public static void displayResultsAfterSingleMatchAlternative(Team team1, Team team2)
        {
        ...
        public static void DisplayLeagueResultsAlternative(List<Team> league)
        {
            Console.WriteLine(String.Format("|{0,5}|{1,5}|{2,5}|{3,5}|{4,5}|{5,5}", "Team Name", "Points", "Goals", "Wins", "Draws", "Losses"));
        ...
        {
            Console.Clear();
            var table = new ConsoleTable("Team Name", "Points", "Goals", "Wins", "Draws", "Losses");
                table.AddRow(team1.Name, team1.CurrentPoints,
                    team1.Players.Sum(player => player.Goals), team1.Wins, team1.Draws, team1.Losts)
                .AddRow(team2.Name, team2.CurrentPoints,
                team2.Players.Sum(player => player.Goals), team2.Wins, team2.Draws, team2.Losts);
        ...
        public static void DisplayLeagueResults(List<Team> league)
        {
            ...
            foreach (var team in league)
            {
                table.AddRow(team.Name, team.CurrentPoints,
                    team.Players.Sum(player => player.Goals), team.Wins, team.Draws, team.Losts);
            }
            table.Write();
            Console.WriteLine();
        }
